...
public class myframe extends javax.swing.JFrame {
 ...
 try {
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/myproject","root","");
            PreparedStatement ps=con.prepareStatement("insert into consumer(name,age,gender)values(?,?,?)");
            ps.setString(1, name);
            ps.setString(2, age);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/myproject","root","");
            PreparedStatement ps=con.prepareStatement("Update consumer set name=?,age=?,gender=? where id=?");
            ps.setString(1, name);
            ps.setString(2, age);
           if(jRadioButton1.isSelected())
           {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/myproject","root","");
            PreparedStatement ps=con.prepareStatement("Delete from consumer where id=?");
